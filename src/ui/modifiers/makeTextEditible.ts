...
// type TSetupEditor = (x: number, y: number, width: number, height: number) => void;
function makeTextEditible(
  ...
  text.on('dblclick dbltap', () => {
    ...
    console.log('🚀 ~ file: makeTextEditible.ts ~ line 28 ~ text.on ~ textPosition', textPosition);
    ...
    editorController.width(text.width() - text.padding() * 2);
    editorController.height(text.height() - text.padding() * 2 + 5);
    ...
    // textarea.focus();
    editorController.outsideClickTrackerRef.current?.focus();
    ...
    function removeTextarea() {
      ...
      text.show();
      console.log(editorController.values.width(), editorController.values.height());
      text.width(editorController.values.width());
      text.height(editorController.values.height());
      transformer?.show();
    ...
    //   }
    // }
    editorController.onClickOutside(removeTextarea);
    // setTimeout(() => {
